...
- Windows Release linking, integration tests, qpdf/Poppler cross-validation, 50-cycle memory smoke, and portable-package dependency checks now pass with the local Qt 6.10.2 validation toolchain; formal Qt 6.11.2 three-platform gates remain open.
