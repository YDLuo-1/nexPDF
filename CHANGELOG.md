...
- Windows Release linking, integration tests, qpdf/Poppler cross-validation, and portable-package dependency checks now pass with the unified Qt 6.11.2 installation; Linux/macOS release gates remain open.
